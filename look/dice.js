...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-2fa7f6ad');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-2fa7f6ad');}
...
function clearFlash(){dieView.classList.remove('rl-win-2fa7f6ad');dieView.classList.remove('rl-lose-2fa7f6ad');if(frameEl){frameEl.classList.remove('rl-win-2fa7f6ad');frameEl.classList.remove('rl-lose-2fa7f6ad');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-2fa7f6ad');if(frameEl){frameEl.classList.add('rl-win-2fa7f6ad');}}else{dieView.classList.add('rl-lose-2fa7f6ad');if(frameEl){frameEl.classList.add('rl-lose-2fa7f6ad');}}
...
var brandEl=document.querySelector('.rl-brand-2fa7f6ad');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
